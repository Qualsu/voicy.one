...
export default function Terms() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            let response = await fetch("https://raw.githubusercontent.com/KenykaGit/Voicy/refs/heads/main/terms.md")
            const markdownText = await response.text()
            setMarkdown(markdownText)

            response = await fetch("https://api.github.com/repos/KenykaGit/Voicy/commits?path=terms.md&page=1&per_page=1")
